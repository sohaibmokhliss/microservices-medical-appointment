package com.healthcare.rdv.events;
...
public class AppointmentEvent implements Serializable {
    ...
    public AppointmentEvent(String eventType, Long appointmentId, Long docteurId, 
                          String patientNom, String patientPrenom, String patientEmail, 
                          String patientTelephone, LocalDateTime dateHeure, String motif, String statut) {
        this();
